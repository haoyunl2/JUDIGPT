...
- **Python 3.12+**: Required for JUDIGPT
- **Julia 1.11+**: Required for JUDI.jl
- **JUDIGPT**: The parent JUDIGPT package must be installed
...
- Install JUDIGPT package from parent directory
...
# Install JUDIGPT package (from parent directory)
pip install -e ../  # or pip install judigpt if installed via pip
...
uv pip install -e ../  # Install JUDIGPT from parent directory
...
- This tutorial requires the JUDIGPT package to be installed (from parent directory)
